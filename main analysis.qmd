...
if (!file.exists(file.path("./data", fname))) {
  print("saved the binned summary csv file!")
  data.table::fwrite(df_summary, file = file.path("./data", fname))
} else {
  "binned summary csv file already exists, did not save a new one."
}
...
d |>
  ...
  labs(
    ...
    title = "Pareto for First-Failed Criteria",
    x = NULL,
    y = "(%)",
    caption = paste(sep = "\n",
                    "Notes:",
